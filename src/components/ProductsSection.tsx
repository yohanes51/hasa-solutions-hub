...
const products: Product[] = [
  ...
  },
  {
    ...
    specs: ["Roll ±60 meter", "Ketebalan 134 gram", "Lebar 120 cm"],
    price: "Rp 10.600",
    moq: "±2000 roll",
    readyTime: "1-14 hari kerja",
  ...
  // New Products
  {
    id: "poly-micro-stretch-150",
    name: "Poly Micro Stretch 150gsm",
    category: "polyester",
    description: "Kain polyester stretch berkualitas tinggi dengan tekstur halus dan elastisitas optimal.",
    specs: ["150gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  {
    id: "poly-micro-stretch-180",
    name: "Poly Micro Stretch 180gsm",
    category: "polyester",
    description: "Kain polyester stretch dengan ketebalan medium, cocok untuk berbagai aplikasi.",
    specs: ["180gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
    image: "https://images.unsplash.com/photo-1558171813-4c088753af8f?w=400&h=300&fit=crop",
  ...
  {
    id: "poly-micro-stretch-210",
    name: "Poly Micro Stretch 210gsm",
    category: "polyester",
    description: "Kain polyester stretch tebal dengan daya tahan tinggi untuk kebutuhan premium.",
    specs: ["210gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
    image: "https://images.unsplash.com/photo-1558171813-4c088753af8f?w=400&h=300&fit=crop",
  ...
  {
    id: "satin-velvet-150",
    name: "Satin Velvet 150gsm",
    category: "polyester",
    description: "Kain satin velvet dengan kilau elegan, ideal untuk busana formal dan dekorasi.",
    specs: ["150gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  {
    id: "satin-velvet-180",
    name: "Satin Velvet 180gsm",
    category: "polyester",
    description: "Kain satin velvet tebal dengan tekstur mewah dan kualitas premium.",
    specs: ["180gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  {
    id: "spunlike-150",
    name: "Spunlike 150gsm",
    category: "polyester",
    description: "Kain spunlike dengan tekstur lembut menyerupai katun, nyaman dipakai.",
    specs: ["150gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  {
    id: "spunlike-180",
    name: "Spunlike 180gsm",
    category: "polyester",
    description: "Kain spunlike tebal dengan karakter mirip katun untuk berbagai kebutuhan.",
    specs: ["180gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  },
  {
    ...
    name: "Ripstop 150gsm",
    category: "polyester",
    description: "Kain ripstop anti sobek dengan kekuatan tinggi untuk aplikasi outdoor dan tas.",
    specs: ["150gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  },
  {
    ...
    name: "Ripstop 180gsm",
    category: "polyester",
    description: "Kain ripstop tebal dengan daya tahan ekstra untuk produk heavy duty.",
    specs: ["180gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  {
    id: "asahi-sponge-150",
    name: "Asahi / Sponge 150gsm",
    category: "polyester",
    description: "Kain asahi/sponge dengan tekstur lembut untuk jersey dan pakaian olahraga.",
    specs: ["150gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  {
    id: "asahi-sponge-180",
    name: "Asahi / Sponge 180gsm",
    category: "polyester",
    description: "Kain asahi/sponge tebal dengan kualitas premium untuk jersey profesional.",
    specs: ["180gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  },
  {
    ...
    name: "Taffeta 150gsm",
    category: "polyester",
    description: "Kain taffeta ringan dengan kilau halus untuk lining dan dekorasi.",
    specs: ["150gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  },
  {
    ...
    name: "Taffeta 180gsm",
    category: "polyester",
    description: "Kain taffeta tebal dengan finishing premium untuk berbagai aplikasi.",
    specs: ["180gsm", "Lebar 150cm", "Warna Bisa Request"],
    price: "Hubungi Kami",
    moq: "1.200 yard",
    readyTime: "1-14 hari kerja",
  ...
  // Coal Products
  {
    ...
    specs: ["High calorie 0-50", "Kualitas Premium"],
    price: "Rp 1.310 + PPN",
    moq: "±30 ton",
